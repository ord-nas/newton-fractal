#ifndef _CROW_FRACTAL_SERVER_COMPLEX_ARRAY_HAND_ROLLED_
#define _CROW_FRACTAL_SERVER_COMPLEX_ARRAY_HAND_ROLLED_
...
#endif // _CROW_FRACTAL_SERVER_COMPLEX_ARRAY_HAND_ROLLED_
